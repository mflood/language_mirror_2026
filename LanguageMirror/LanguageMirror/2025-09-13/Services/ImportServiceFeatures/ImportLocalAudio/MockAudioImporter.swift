//
//  MockAudioImporter.swift
//  LanguageMirror
//
//  Created by Matthew Flood on 9/20/25.
//

// Features/ImportingAudio/MockAudioImporter.swift
import Foundation

public final class MockAudioImporter: AudioImporting {
    ...
    public func prepareLocalAudio(from url: URL) async throws -> URL {
        ...
        guard let sample = Bundle.main.url(forResource: "sample", withExtension: "mp3") else {
            throw LocalAudioImportError.notFound
        }
        return sample
    }
}
